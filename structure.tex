...
\renewcommand{\captionfont}{\it \small \sc}
...
{\addvspace{15pt}\LARGE\sffamily\bfseries} % Spacing and font options for Part
{\color{ocre!60}\contentslabel[\LARGE Partie : \thecontentslabel]{3cm}\color{ocre}} % Part number
{}  
...
{\color{ocre!60}\contentslabel[\Large Chapitre : \thecontentslabel]{3cm}\color{ocre}} % Chapter number
{}  
{\color{ocre!60}\normalsize\sffamily\bfseries\;\titlerule*[.5pc]{.}\;\thecontentspage} % Page number
[]
...
{12pt}
{\sffamily\Huge\bfseries\scshape\filcenter}